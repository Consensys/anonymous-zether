...
contract ZKP {
    ...
    function verifyTransfer(bytes32[2][] calldata CLn, bytes32[2][] calldata CRn, bytes32[2][] calldata L, bytes32[2] calldata R, bytes32[2][] calldata y, uint256 epoch, bytes32[2] calldata u, bytes calldata proof) view external returns (bool) {
        // return zetherVerifier.verifyTransfer(CLn, CRn, L, R, y, epoch, u, proof);
