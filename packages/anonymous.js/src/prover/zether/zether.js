...
class ZetherProver {
    constructor() {
        ...
        this.generateProof = (statement, witness) => {
            ...
            var y = utils.hash(bn128.serializeInt(statementHash), bn128.serializePoint(a), bn128.serializePoint(s));
            ...
            var z = utils.hash(bn128.serializeInt(y));
            ...
            var x = utils.hash(bn128.serializeInt(z), ...polyCommitment.getCommitments());
